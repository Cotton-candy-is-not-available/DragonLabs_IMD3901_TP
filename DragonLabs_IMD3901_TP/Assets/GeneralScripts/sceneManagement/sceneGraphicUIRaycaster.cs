...
public class sceneGraphicUIRaycaster : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Mouse.current == null) return;
        {
            ...
            foreach (RaycastResult result in results)
            {
                ...
                {
                    pinataPopButton.GetComponent<Button>().OnDeselect(null);

                }
                //EventSystem.current.SetSelectedGameObject(pinataPopButton.gameObject, new BaseEventData(EventSystem.current));
